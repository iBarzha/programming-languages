...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        page_combo.addItems(["Фото", "Опис", "Додаткова інформація"])
        ...
        pg2_form.addRow("Порода:", QLabel("Norwegian Forest cat"))
        pg2_form.addRow("Походження:", QLabel("Norway"))
        ...
        pg3_form.addRow(QLabel("Введіть дані про кота."))
        pg3_form.addRow("Ім'я:", QLineEdit())
        pg3_form.addRow("Колір:", QLineEdit())
        ...
        pg3_form.addRow("Вага (кГ):", weight_dsb)
