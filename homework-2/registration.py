...
class NewUserDialog(QDialog):
    ...
    def initializeUI(self):
        ...
        self.setWindowTitle("3.1 - Реєстрація користувача")
        self.setUpWindow()

    def setUpWindow(self):
        """Create and arrange widgets in the window for
        collecting new account information."""
        login_label = QLabel("Новий користувач", self)
        ...
        name_label = QLabel("Псевдонім:", self)
        name_label.move(20, 144)

        self.name_edit = QLineEdit(self)
        self.name_edit.resize(230, 24)
        self.name_edit.move(110, 140)

        full_name_label = QLabel("Повне ім'я:", self)
        full_name_label.move(20, 174)

        full_name_edit = QLineEdit(self)
        full_name_edit.resize(230, 24)
        full_name_edit.move(110, 170)
        ...
        self.new_pswd_edit.move(110, 200)

        confirm_label = QLabel("Підтвердження:", self)
        confirm_label.move(20, 234)

        self.confirm_edit = QLineEdit(self)
        self.confirm_edit.setEchoMode(QLineEdit.EchoMode.Password)
        self.confirm_edit.resize(230, 24)
        self.confirm_edit.move(110, 230)
